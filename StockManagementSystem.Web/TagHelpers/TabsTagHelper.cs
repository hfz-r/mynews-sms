...
namespace StockManagementSystem.Web.TagHelpers
{
    ...
    public class TabsTagHelper : TagHelper
    {
        ...
        public string TabNameToSelect { get; set; }
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<TabContextItem>();
            ...
            if (string.IsNullOrEmpty(RenderSelectedTabInput) || renderSelectedTabInput)
            {
                ...
                if (output.Attributes.ContainsName("id"))
                {
                    ...
                    script.InnerHtml.AppendHtml("$(document).ready(function () { bindBootstrapTabSelectEvent('" +
                                                output.Attributes["id"].Value + "', 'selected-tab-name');});");
    ...
    public class TabTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<TabContextItem>)context.Items[typeof(TabsTagHelper)];
