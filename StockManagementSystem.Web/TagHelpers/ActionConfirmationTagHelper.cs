...
{
    [HtmlTargetElement("_action-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class ActionConfirmationTagHelper : TagHelper
    {
        ...
        public ActionConfirmationTagHelper(IHtmlHelper htmlHelper, IHtmlGenerator generator)
        {
