...
namespace StockManagementSystem.Api.Helpers
{
    public static class CryptoHelper
    {
        ...
        public static RsaSecurityKey CreateRsaSecurityKey()
        {
            if (_key == null)
            {
                string pathToKey = CommonHelper.DefaultFileProvider.MapPath(
                    $"~/App_Data/{ApiSettingsDefaults.TokenSigningKeyFileName}");
        ...
        /// <summary>
        /// References: https://github.com/mrsheepuk/ASPNETSelfCreatedTokenAuthExample/blob/master/src/TokenAuthExampleWebApplication/RSAKeyUtils.cs
        /// </summary>
