...
using StockManagementSystem.Api.IdentityServer.Extensions;
...
namespace StockManagementSystem.Api.IdentityServer.Endpoints
{
    public class AuthorizeResult : IEndpointResult
    {
        ...
        private void AddSecurityHeaders(HttpContext context)
        {
            ...
            var csp =
                $"default-src 'none'; frame-ancestors {formOrigin}; form-action {formOrigin}; script-src 'sha256-VuNUSJ59bpCpw62HM2JG/hCyGiqoPN3NqGvNXQPU+rY='; ";
        ...
        private const string FormPostHtml =
                "<form method='post' action='{uri}'>{body}</form><script>(function(){document.forms[0].submit();})();</script>";
