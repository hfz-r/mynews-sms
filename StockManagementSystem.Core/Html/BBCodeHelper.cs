...
namespace StockManagementSystem.Core.Html
{
    public class BBCodeHelper
    {
        ...
        public static string FormatText(string text, bool replaceBold, bool replaceItalic, bool replaceUnderline,
            bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                var newWindow = true; //TODO: move to setting
                // format the URL tags: [url=https://www.webSite.com]my site[/url]
                // becomes: <a href="https://www.webSite.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.webSite.com[/url]
                // becomes: <a href="https://www.webSite.com">https://www.webSite.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.webSite.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.webSite.com/Content/Images/Image.jpg">
