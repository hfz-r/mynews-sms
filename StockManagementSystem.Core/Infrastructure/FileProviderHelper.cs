...
namespace StockManagementSystem.Core.Infrastructure
{
    ...
    /// </summary>
    public class FileProviderHelper : PhysicalFileProvider, IFileProviderHelper
    {
        public FileProviderHelper(IHostingEnvironment hostingEnvironment)
        ...
        public virtual void CreateFile(string path)
        {
            ...
            // close the file after it's created
