...
namespace StockManagementSystem.Core.Infrastructure
{
    ...
    {
        protected IFileProviderHelper _fileProvider;
        ...
        /// <summary>Gets or sets whether we should iterate assemblies in the app domain when loading types. 
