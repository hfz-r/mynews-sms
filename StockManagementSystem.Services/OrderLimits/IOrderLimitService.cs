...
namespace StockManagementSystem.Services.OrderLimits
{
    public interface IOrderLimitService
    {
        ...
        Task<IPagedList<OrderLimit>> GetOrderLimitsAsync(int[] storeIds = null, int? percentage = 0, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false);
