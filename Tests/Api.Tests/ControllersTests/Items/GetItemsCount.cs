...
namespace Api.Tests.ControllersTests.Items
{
    ...
    public class GetItemsCount
    {
        ...
        {
            //Arrange
            _itemApiService.Setup(x => x.GetItemsCount(null, null, null, null, 50, 1, 0)).Returns(0);
        ...
        {
            //Arrange
            _itemApiService.Setup(x => x.GetItemsCount(null, null, null, null, 50, 1, 0)).Returns(1);
        ...
        public void Should_return_ok_with_count_equals_to_same_items_when_certain_number_items_exists()
        {
            ...
            //Arrange
            _itemApiService.Setup(x => x.GetItemsCount(null, null, null, null, 50, 1, 0)).Returns(itemsCount);
