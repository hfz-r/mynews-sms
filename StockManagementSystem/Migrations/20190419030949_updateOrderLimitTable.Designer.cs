...
namespace StockManagementSystem.Migrations
{
    ...
    [Migration("20190419030949_updateOrderLimitTable")]
    partial class updateOrderLimitTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockManagementSystem.Core.Domain.Settings.OrderLimit", b =>
                {
                    ...
                    b.Property<int>("DeliveryPerWeek");

                    b.Property<int>("InventoryCycle");

                    b.Property<string>("ModifiedBy");

                    b.Property<DateTime?>("ModifiedOnUtc");

                    b.Property<int>("OrderRatio");
            ...
            modelBuilder.Entity("StockManagementSystem.Core.Domain.Stores.Store", b =>
                {
                    b.HasOne("StockManagementSystem.Core.Domain.Stores.StoreGrouping")
                        .WithMany("Store")
